...
const PreparationPapScreen = () => {
  ...
  return (
    <ImageBackground source={require('./assets/questionitem.png')} style={styles.background}>
      ...
      <Text style={styles.text1}>Preparation</Text>
        ...
        <ImageBackground source={require('./assets/image_41__2_-removebg-preview.png')} style={styles.image2} />

        {/* Add Text component for text2 */}
        <Text style={styles.text2}>To ensure the accuracy of the test, it’s important for women to avoid certain activities before the pap test, such as douching , using tampons or having sexual intercourse for at least 24 hours prior to the test.</Text>
        {/* Add TouchableOpacity for button4 */}
        <TouchableOpacity style={styles.button} onPress={() => handleNavigation('ResultsPap')}>
...
export default PreparationPapScreen;
