  ...
  return (
    <ImageBackground source={backgroundImage} style={styles.background}>
      ...
      <View style={styles.textBox}>
        <Text style={styles.text}>You are under a Low Risk</Text>
      </View>
      {/* Additional Text */}
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('SimilarScreen', { username })}
      >
