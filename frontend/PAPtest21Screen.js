...
const PAPtest21Screen = () => {
  const navigation = useNavigation(); // Use useNavigation hook to get the navigation object

  const handleNavigateToPAPtest21_29Screen = () => {
    navigation.navigate('PAPtest21_29'); // Navigate to "21 to 29" screen
  };
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={backgroundImage} style={styles.background}>
        ...
        <Text style={styles.text1}>You do not need screening</Text>
        {/* New Text 2 */}
        <Text style={styles.text2}>If you are younger than 21</Text>
      </ImageBackground>
      {/* Add image2 */}
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={handleNavigateToPAPtest21_29Screen}>
...
export default PAPtest21Screen;
