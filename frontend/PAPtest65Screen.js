...
const PAPtest65Screen = () => {
  const navigation = useNavigation();

  const handleNavigateToPAPtest65_29Screen = () => {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={backgroundImage} style={styles.background}>
        ...
        <Text style={styles.text1}>If you are older than 65</Text>
        {/* New Text 2 */}
        <Text style={styles.text2}>
          If 3 pap test is negative
        </Text>
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={handleNavigateToPAPtest65_29Screen}>
...
export default PAPtest65Screen;
