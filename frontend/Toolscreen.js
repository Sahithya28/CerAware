    ...
    <ImageBackground source={backgroundImage} style={styles.background}>
      <View style={styles.container}>
        <View style={styles.topLeftContainer}>
          ...
          <Text style={styles.investigationText}>Investigation Tools</Text>
          <Text style={{ width: screenWidth * 0.25, height: screenHeight * 0.04, top: screenHeight * 0.23, left: windowHeight * -0.35, fontSize: Math.min(screenWidth, screenHeight) * 0.05, fontWeight: '600' }}>Click here:</Text>
        </View>
        
        {/* Box 1 */}
        <TouchableOpacity
          style={styles.box1}
          onPress={() => navigation.navigate('PAPtest')}>
          {/* Text 1 */}
          <Text style={styles.text}>PAP Test</Text>
        ...
        <TouchableOpacity
          style={styles.box2}
          onPress={() => navigation.navigate('HPVtest')}>
          {/* Text 2 */}
          <Text style={styles.text}>HPV Test</Text>
          {/* Add any content inside the box if needed */}
        </TouchableOpacity>
