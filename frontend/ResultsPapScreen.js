  ...
  return (
    <ImageBackground source={require('./assets/questionitem.png')} style={styles.background}>
      ...
      <Text style={styles.text1}>Results</Text>
        ...
        <ImageBackground source={require('./assets/image_41-removebg-preview.png')} style={styles.image2} />

        {/* Add Text component for text2 */}
        <Text style={styles.text2}>The results of a pap test are usually reported as either normal, abnormal or in conclusive. If abnormal cells are defected, further testing or follow-up may be recommended.</Text>
        {/* Add TouchableOpacity for button4 */}
        <TouchableOpacity style={styles.button} onPress={() => handleNavigation('TkmScreen')}>
...
export default ResultsPapScreen;
