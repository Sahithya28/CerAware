  ...
  return (
    <ImageBackground source={backgroundImage} style={styles.background}>
      ...
      <View style={styles.textBox}>
        <Text style={styles.text}>You are under a Moderate Risk</Text>
      </View>
      {/* Additional Text */}
      ...
      <TouchableOpacity 
        ...
        onPress={() => navigation.navigate('Similar2Screen', { username })} // Ensure username is passed correctly
      >
...
export default Age21to34Screen;
