...
import image2 from './assets/image_22-removebg-preview.png';
...
const LTBCScreen = () => {
  ...
  const handleNavigateToChlamydiaScreen = () => {
    navigation.navigate('ChlamydiaScreen');
  };
  ...
  return (
    <ImageBackground source={backgroundImage} style={styles.background}>
      ...
      <TouchableOpacity style={styles.button} onPress={handleNavigateToChlamydiaScreen}>
        <Text style={styles.buttonText}>Next</Text>
      </TouchableOpacity>

      {/* Text Elements */}
      <Text style={styles.text1}>Long-term use of Birth 
      {'\n'}control pills 
      </Text>
